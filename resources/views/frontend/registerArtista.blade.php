	...
	@section('conteudoPagina')
		...
		<div id="hero_register">
			<div class="container margin_120_95">			
				<div class="row">
					<div class="col-lg-6">
						<h1>Junta-te ao mundo da música!</h1>
						<p class="lead">Não percas tempo. Aqui encontrarás o teu espaço musical, feito a pensar em ti!</p>
						<div class="box_feat_2">
							<i class="pe-7s-pin"></i>
							<h3>Terás máxima visibilidade, terás um website só teu</h3>
							<p>Promovemos a tua página ao público em geral e a organizadores de eventos que pretendem contratar pessoas para espetáculos.</p>
						</div>
						<div class="box_feat_2">
							<i class="pe-7s-date"></i>
							<h3>Gere os teus eventos de forma fácil</h3>
							<p>Poderás fazer marcações, tornar a tua aenda pública para os teus seguidores e para quem organiza eventos!</p>
						</div>
						<div class="box_feat_2">
							<i class="pe-7s-graph1"></i>
							<h3>Encontra novos negócios</h3>
							<p>Já pensaste em quantos locais poderias atuar? Supera-te. Encontra aqui motivos para que o teu trabalho seja reconhecido.</p>
						</div>
					</div>
					<!-- /col -->
					<div class="col-lg-5 ml-auto">
						<div class="box_form">
							...
							<form method="post" action="{{ URL::action('RegisterController@registoArtista') }}" id="novoRegisto">
								{{ csrf_field() }}
			                    ...
			                    <div class="row">
									<div class="col-lg-12 ">
										<div class="form-group">
											<p>Estás a registar-se como <b>Artista WOTE</b>. Conhece as vantagens de ser Premium. Potencia ainda mais a tua carreira!</p>
											...
											<input id="tipoConta" value="1" name="tipoConta" style="display: none;">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<?php if($erros['nomeArtistico'] != '') { ?>
						                        <span class="help-block">
						                            <strong><?php echo $erros['nomeArtistico'];?></strong>
						                        </span>
						                    <?php } ?>
											<input type="text" class="form-control" placeholder="Nome Artístico" name="nomeArtistico" id="nomeArtistico" value="<?php if(isset($valores) && $valores['nomeArtistico']) echo $valores['nomeArtistico'];?>">
										</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
						                    ...
						                    <?php } ?>
											<select class="form-control" name="tiposEspetaculos[]" id="tiposEspetaculos" multiple='multiple' placeholder="Categorias de Atuação">
								...
								<!-- /row -->
								<div><input type="submit" class="btn_1" value="Registar" id="registarArtista"></div>
