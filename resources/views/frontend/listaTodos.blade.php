@extends('frontend.template.template')
   ...
   <div id="results">
       <div class="container">
           <div class="row">
               <div class="col-md-6">
                   <h4><strong>Showing 10</strong> of {{ count($all) }} results (fazer contas)</h4>
               </div>
               <div class="col-md-6">
				...
				<div class="row">
					<div style="float: left;" class="col-lg-6">
					  <?php 
						  ...
						  <?php } 
						  		elseif(in_array($id, $artistasIds, true)) // Artista
						  		{ 
						  			$artista = $artistas[$id] ?>
									...
									<div class="box_list wow fadeIn">
										<a href="#0" class="wish_bt"></a>
										<figure>
											<a href="/artista/{{$artista->id}}"><img src="{{ $artistasProfilePics[$artista->id] }}" class="img-fluid" alt="">
												<div class="preview"><span>Ler mais</span></div>
											</a>
										</figure>
										<div class="wrapper">
						  ...
						  <?php } 
						  		...
						  		{ 
						  			$organizador = $organizadores[$id] ?>

									<div class="box_list wow fadeIn">
										<a href="#0" class="wish_bt"></a>
										<figure>
											<a href="/organizador/{{$organizador->id}}"><img src="{{ $organizadoresProfilePics[$organizador->id] }}" class="img-fluid" alt="">
												<div class="preview"><span>Ler mais</span></div>
											</a>
										</figure>
										<div class="wrapper">
