			...
			<div class="content">
				...
				<form method="get" action="{{ URL::action('SearchController@index') }}" class="formPesquisaHome">
					<div id="custom-search-input">
						...
						<ul>
							<li>
								<input type="radio" id="all" name="tipoPesquisa" value="0" checked>
								<label for="all">Tudo</label>
							</li>
							<li>
								<input type="radio" id="artistas" name="tipoPesquisa" value="1">
								<label for="artistas">Artistas</label>
							</li>
							<li>
								<input type="radio" id="eventos" name="tipoPesquisa" value="2">
								<label for="eventos">Eventos</label>
							</li>
							<li>
								<input type="radio" id="organizadores" name="tipoPesquisa" value="3">
