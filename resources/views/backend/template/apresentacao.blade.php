		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-6">
					<div id="logo_home">
						<h1><a href="{{ asset('index.html') }}" title="Wote">Wote</a></h1>
					</div>
				</div>
				<div class="col-lg-9 col-6">
					...
					<nav id="menu" class="main-menu">
						...
						<ul>
							...
							<li>
								<span><a href="#0">Organizadores</a></span>
								<ul>
                            ...
                            <?php if( Auth::user() ) { ?>
                            <li>
								<span><a href="#0">Meu Espaço Musical</a></span>
								<ul>
