...
INSERT INTO `evento` (`idEvento`, `tituloEvento`, `idUtilizador`, `descricaoEvento` ,`dataInicioEvento` ,`idLocal`, `urlImagemEvento`) VALUES
(1, 'Festa da Nossa Senhora da Agonia', 14, 'Nasce a Romaria Sra. da Agonia de uma Via Sacra que partindo do Convento Franciscano de Sto. António, rematava no antigo morro da forca. Foi aí que se construiu a Capela do Bom Jesus do Santo Sepulcro (1674), o Bom Jesus da Via Sacra. A devoção à Senhora da Agonia ocorre a partir de 1751.', '2018-02-14 21:00', 2, 'http://www.nsagonia.com.br/wp-content/gallery/conheca-o-santuario/n_s_agonia.jpg'),
(2, 'Festa da Salxixeira', 14, 'Num supermercado chamado Shopwell, as comidas e demais produtos que lá vivem têm adoração pelos humanos, que vão lá para fazer compras e os levam para o Grande Além. Entre os produtos do supermercado está Frank, uma salsicha que sonha fazer sexo com sua namorada Brenda, um pão de cachorro-quente, quando ambos forem juntos para o Grande Além. Frank vive numa embalagem com seus melhores amigos Barry e Carl, que também anseiam pelo Grande Além.', '2018-02-20 15:30', 4, 'http://www.exatomaquinas.com.br/imagens/produtos//Equipamentos/Buffets/SalsicheiraBM.jpg'),
(3, 'Queima das Fitas', 14, 'A história da Queima das Fitas no Porto não é muito mais recente que a de Coimbra, que se iniciou em 1919, pois já em 1920, os finalistas de Medicina da Universidade do Porto faziam a chamada Festa da Pasta, que é considerada a origem da Queima das Fitas do Porto. A Festa da Pasta era um evento, com um grande espírito académico, que comemorava a passagem da pasta dos estudantes que estavam a terminar o seu curso, os quintanistas, aos que entravam na recta final, os quartanistas. Juntamente com a passagem da pasta era imposto o grelo aos quartanistas.', '2018-03-17 22:00', 1, 'http://www.porto.pt/assets/misc/q13.jpg'),
(4, 'Enterro do Cão', 14, 'O Enterro da Gata é uma festa académica da cidade de Braga, Portugal. Actualmente é organizada pela Associação Académica da Universidade do Minho. A Universidade Católica de Braga também participa neste evento académico. A gata representa o indesejado insucesso escolar. É feito um velório em que a Gata é transportada pelas artérias da cidade de Braga seguida por um séquito que não pára de chorar a finada. As festas têm a duração de uma semana e realizam-se todos os anos no início do mês de Maio.', '2018-05-21 07:00', 1, 'http://diariogaucho.rbsdirect.com.br/imagesrc/23318229.jpg?w=620'),
(5, 'Pingo Doce Festival', 14, 'O Pingo Doce é uma cadeia líder no segmento de supermercados em Portugal que oferece produtos alimentares de qualidade a preços competitivos. Tem mais de 400 lojas, entre elas: supermercados, hipermercados, lojas de conveniência, restauração, entre outros serviços. A história do Pingo Doce começa em 1980 ...', '2018-02-27 12:00', 2, 'https://www.dinheirovivo.pt/wp-content/uploads/2015/12/Pingo-doce-final-de-ano.jpg'),
(6, 'JazzCuzi', 14, 'Jazz é uma manifestação artístico-musical originária de comunidades de Nova Orleães, nos Estados Unidos.[1] Tal manifestação teria surgido por volta do final do século XIX na região de Nova Orleães, tendo origem na cultura popular e na criatividade das comunidades negras que ali viviam, um de seus espaços de desenvolvimento mais importantes.', '2018-02-20 16:20', 5, 'https://i.ytimg.com/vi/PJKA6qcfQ7Q/maxresdefault.jpg'),
(7, 'Whose Blues Blue', 14, 'Blues é um gênero e forma musical originado por afro-americanos no extremo sul dos Estados Unidos em torno do fim do século XIX. O gênero se desenvolveu a partir de raízes das tradições musicais africanas, canções de trabalho afro-americanas, spirituals e música tradicional. O blues incorporou spirituals, canções de trabalho, canto de campo, ring shout, chant e baladas narrativas simples e rimadas. A forma do blues, onipresente no jazz, no rhythm and blues e no rock and roll, é caracterizada pelo padrão de chamada e resposta, pela escala de blues e por progressões de acordes específicas, das quais o blues de doze compassos é o mais comum. Blue note é uma nota cantada ou tocada com um timbre ligeiramente mais baixo do que o da escala maior, o que faz com que a nota tenha um som distintivamente triste e melancólico; a própria palavra blues, em inglês, é sinônimo de melancolia. Blues shuffles ou linha de baixo reforçam o ritmo de transe e formam um efeito repetitivo conhecido como groove.', '2018-02-22 23:00', 5, 'http://poconosecrets.com/wp-content/uploads/2016/01/Blues-Hughes.jpg'),
(8, 'Aniversário TOCA', 9, 'A TOCA - Trabalho de uma Oficina Cultural e Associativa foi ontem formalmente inaugurada, meses após o início do seu funcionamento como espaço cultural alternativo para Braga. A transformação dos Cinemas Avenida em casa de várias associações e palco para o desenvolvimento de expressões artísticas diversas foi apontada pelo secretário de Estado do Desporto e Juventude como uma boa prática que deve ser replicada noutros locais do país.', '2018-02-16 17:45', 3, 'https://scontent.fopo2-2.fna.fbcdn.net/v/t1.0-9/1459867_842593505770307_289709564_n.jpg?oh=994c44b445e6eec0681335620f110a83&oe=5B19D384');
...
--
-- Extraindo dados da tabela `perfilZonasAtuacao`
--
insert  into perfilZonasAtuacao (idPerfil, idConcelho) values
 (1,1),
 (2,2),
 (3,3),
 (4,4),
